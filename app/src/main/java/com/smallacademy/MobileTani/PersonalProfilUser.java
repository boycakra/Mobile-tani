...
public class PersonalProfilUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tampilan_profiluser);
        user = (userpembeli) getIntent().getSerializableExtra("Users");
